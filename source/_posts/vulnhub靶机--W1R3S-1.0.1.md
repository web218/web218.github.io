...
![image.png](vulnhub靶机--W1R3S-1.0.1/image.png)
...
![image.png](vulnhub靶机--W1R3S-1.0.1/image 1.png)

在实战中有时候apache页面会隐藏一些信息：

ctrl+u 查看页面源码注释

![image.png](vulnhub靶机--W1R3S-1.0.1/image 2.png)
...
![image.png](vulnhub靶机--W1R3S-1.0.1/image 3.png)
...
![image.png](vulnhub靶机--W1R3S-1.0.1/image 4.png)
...
![image.png](vulnhub靶机--W1R3S-1.0.1/image 5.png)

点击问号，这里有一些小tips，看了一下，没有有价值的信息，下面重装数据库

![image.png](vulnhub靶机--W1R3S-1.0.1/image 6.png)

可以看到文件和表格都已经能编辑成功，唯一出现问题的就是管理员的用户未创建

这个页面我们可以查看源码

![image.png](vulnhub靶机--W1R3S-1.0.1/image 7.png)
...
![image.png](vulnhub靶机--W1R3S-1.0.1/image 8.png)
...
![image.png](vulnhub靶机--W1R3S-1.0.1/image 9.png)

发现没有任何回显，查看源码看看：


![image.png](vulnhub靶机--W1R3S-1.0.1/image 10.png)
...
![image.png](vulnhub靶机--W1R3S-1.0.1/image 11.png)
